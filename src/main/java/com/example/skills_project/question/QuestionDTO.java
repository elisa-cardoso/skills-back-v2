...
public class QuestionDTO {
    ...
    @Size(min = 1, max = 500, message = "A opção A deve ter entre 1 e 100 caracteres.")
    private String optionA;

    @NotNull(message = "A opção B é obrigatória.")
    @Size(min = 1, max = 500, message = "A opção B deve ter entre 1 e 100 caracteres.")
    private String optionB;

    @NotNull(message = "A opção C é obrigatória.")
    @Size(min = 1, max = 500, message = "A opção C deve ter entre 1 e 100 caracteres.")
    private String optionC;

    @NotNull(message = "A opção D é obrigatória.")
    @Size(min = 1, max = 500, message = "A opção D deve ter entre 1 e 100 caracteres.")
